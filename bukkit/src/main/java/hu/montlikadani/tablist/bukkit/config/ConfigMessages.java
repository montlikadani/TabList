...
public final class ConfigMessages {
	...
	public enum MessageKeys {
		...
		FAKE_PLAYER_LIST("fake-player", new String[] { "&cFake players&7 (&e%amount%&7):", "&r%fake-players%" });
		...
		private void path(String mainSection) {
			...
			path = hu.montlikadani.tablist.bukkit.utils.StrUtil.replaceNextChar(path, 0, "_", "", 1).replace('_', '-')

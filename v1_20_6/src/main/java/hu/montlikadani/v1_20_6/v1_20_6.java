package hu.montlikadani.v1_20_6;
...
public final class v1_20_6 implements hu.montlikadani.api.IPacketNM {
    ...
    public EntityPlayer getPlayerHandle(Player player) {
        return ((org.bukkit.craftbukkit.v1_20_R4.entity.CraftPlayer) player).getHandle();
    }
    ...
    private MinecraftServer minecraftServer() {
        return ((org.bukkit.craftbukkit.v1_20_R4.CraftServer) Bukkit.getServer()).getServer();
    }
    ...
    public ClientboundPlayerInfoRemovePacket removeEntityPlayers(Object... entityPlayers) {
        ...
        for (Object one : entityPlayers) {
            players.add(((EntityPlayer) one).gb().getId());
        }
        ...
        private void scoreboardTeamPacket(PacketPlayOutScoreboardTeam packetScoreboardTeam) {
            ...
            packetScoreboardTeam.h().ifPresent(packetTeam -> {
                ...
                if ((prefix != null && !prefix.getString().isEmpty()) || (suffix != null && !suffix.getString().isEmpty())) {
                    ...
                    ScoreboardTeam scoreboardTeam = new ScoreboardTeam(((org.bukkit.craftbukkit.v1_20_R4.scoreboard.CraftScoreboard)

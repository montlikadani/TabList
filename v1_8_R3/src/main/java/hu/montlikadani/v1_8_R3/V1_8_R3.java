...
public final class V1_8_R3 implements IPacketNM {
	...
	public PacketPlayOutPlayerInfo newPlayerInfoUpdatePacketAdd(Object... entityPlayers) {
		return new PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.EnumPlayerInfoAction.ADD_PLAYER, (EntityPlayer[]) entityPlayers);
	}
	...
	public PacketPlayOutPlayerInfo removeEntityPlayers(Object... entityPlayers) {
		return new PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.EnumPlayerInfoAction.REMOVE_PLAYER, (EntityPlayer[]) entityPlayers);
	}
		...
		public void write(ChannelHandlerContext ctx, Object msg, io.netty.channel.ChannelPromise promise) throws Exception {
			...
			for (Class<?> cl : classesToListen) {
				...
				if (playerInfoAction.get(playerInfoPacket) == PacketPlayOutPlayerInfo.EnumPlayerInfoAction.UPDATE_GAME_MODE) {
					java.util.ListIterator<PacketPlayOutPlayerInfo.PlayerInfoData> entryListIterator = ((List<PacketPlayOutPlayerInfo.PlayerInfoData>) infoList
							.get(playerInfoPacket)).listIterator();

					while (entryListIterator.hasNext()) {
						PacketPlayOutPlayerInfo.PlayerInfoData infoData = entryListIterator.next();
